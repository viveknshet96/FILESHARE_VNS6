...
const bcrypt = require('bcryptjs'); // Make sure bcryptjs is at the top
const User = require('../models/User'); // Make sure User model is at the top

router.post('/create-guest-user', async (req, res) => {
    try {
        const guestEmail = 'guest@vshare.com';
